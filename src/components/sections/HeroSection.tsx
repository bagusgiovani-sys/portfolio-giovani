      ...
      <section
        ...
        style={{
          ...
          backgroundImage: isLg
            ? `
              radial-gradient(ellipse 25% 52% at 50% 80%, #4c00ae 70%, transparent 0%),
              radial-gradient(ellipse 35% 62% at 50% 80%, #330175 80%, transparent 0%),
              radial-gradient(ellipse 42% 75% at 50% 80%, #21014b 90%, transparent 0%)`
            : `
            ...
            <GlassCard className="px-2 py-3 text-left">
              ...
              <div className="flex -space-x-3 mt-2 w-full h-full">
                {heroData.clientAvatars.map((avatar, i) => (
                  <div key={i} className="rounded-full flex items-center justify-center text-white text-[8px] font-bold">
                    <Image
                      src={avatar.src}
                      alt={`Client ${i + 1}`}
                      width={36}
